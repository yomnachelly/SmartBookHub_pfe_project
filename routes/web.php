...
Route::middleware(['auth', RoleMiddleware::class . ':admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::prefix('books')->name('books.')->group(function () {
        ...
        Route::post('/{livre}/toggle-stock', [BookController::class, 'toggleStock'])->name('toggle-stock');
        Route::post('/{livre}/toggle-visibility', [BookController::class, 'toggleVisibility'])->name('toggle-visibility');
    });
    ...
    Route::prefix('commandes')->name('commandes.')->group(function () {
        ...
        Route::get('/{id}/download-facture', [CommandeController::class, 'downloadFacture'])->name('downloadFacture');
        Route::post('/{id}/renvoyer-facture', [CommandeController::class, 'renvoyerFacture'])->name('renvoyer.facture');
        Route::get('/{id}/preview-facture', [CommandeController::class, 'previewFacture'])->name('preview.facture');
    });
});
...
Route::middleware(['auth', RoleMiddleware::class . ':employe'])->prefix('employee')->name('employee.')->group(function () {
    ...
    Route::prefix('books')->name('books.')->group(function () {
        ...
        Route::post('/{livre}/toggle-stock', [EmployeeBookController::class, 'toggleStock'])->name('toggle-stock');
    });
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/mes-commandes/{id}/facture', [CommandeController::class, 'downloadFacture'])->name('commandes.facture');
    Route::post('/mes-commandes/{id}/renvoyer-facture', [CommandeController::class, 'renvoyerFacture'])->name('commandes.renvoyer.facture');
