...
<div class="container mx-auto px-4 py-8">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('employee.books.create') }}" 
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-[#1E1E1E] mt-2">
                        {{ number_format($livres->sum(function($livre) { return $livre->prix * $livre->stock; }), 3) }} dt
                    </h3>
                </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
        <form method="GET" action="{{ route('employee.books.index') }}" class="flex flex-col md:flex-row gap-4">
            <div class="flex-1">
                <div class="relative">
                    <input type="text" 
                           name="search"
            ...
            <div class="w-full md:w-64">
                <select name="category" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#01B3BB] focus:border-transparent">
                    <option value="">Toutes les catégories</option>
                    @foreach($categories as $category)
                    <option value="{{ $category->id_categ }}" {{ request('category') == $category->id_categ ? 'selected' : '' }}>
                        {{ $category->nom_categ }}
                    </option>
                    @endforeach
                </select>
            ...
            <a href="{{ route('employee.books.index') }}" class="px-6 py-3 bg-gray-200 text-gray-700 rounded-xl font-medium hover:bg-gray-300 transition">
                Réinitialiser
            </a>
            @endif
        </form>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div class="p-6">
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td class="py-4 px-4">
                                <div class="flex gap-2">
                                    <a href="{{ route('employee.books.edit', $livre) }}" 
                                    ...
                                    <form method="POST" action="{{ route('employee.books.toggle-stock', $livre) }}" class="inline">
                                        @csrf
                                        <button type="submit" 
                                    ...
                                    <form method="POST" action="{{ route('employee.books.destroy', $livre) }}" 
                                          class="inline"
            ...
            <div class="text-center py-12 text-gray-500">
                ...
                <p class="text-sm mb-6">Commencez par <a href="{{ route('employee.books.create') }}" class="text-[#01B3BB] hover:underline">ajouter un nouveau livre</a></p>
                <a href="{{ route('employee.categories.index') }}" class="inline-flex items-center text-[#FFC62A] hover:underline">
