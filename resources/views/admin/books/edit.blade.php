...
<div class="container mx-auto px-4 py-8">
            ...
            <form action="{{ route('admin.books.update', $livre) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div x-data="{ open: false, selected: @json(old('categorie_ids', $livre->categories->pluck('id_categ')->toArray())) }" class="relative w-64">
    ...
    <button @click="open = !open" 
            type="button"
            class="w-full bg-white border border-gray-300 rounded-xl px-3 py-2 text-left focus:outline-none focus:ring-2 focus:ring-[#FFC62A]">
    ...
    <div x-show="open" @click.away="open = false"
        ...
        <label class="flex items-center px-3 py-2 cursor-pointer hover:bg-gray-100">
            <input type="checkbox"
                   ...
                   x-model="selected"
                   class="rounded border-gray-300 text-[#FFC62A] mr-2">
